...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = 'delete from repaircategory where ctgrid = ?';
    $statement = $conn->prepare($sql);
    $statement->bind_param('s', $ctgrid);
...
<body class="container">
    <h1>ระบบแจ้งซ่อมคอมพิวเตอร์: ลบหมวดหมู่อุปกรณ์</h1>
    ...
    ?>
    <p>คุณต้องการลบหรือไม่ ? <b><?php echo $row["ctgrid"];?></b></p>
    <form method="post">
