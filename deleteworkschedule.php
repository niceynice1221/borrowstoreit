...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = 'delete from repairworkschedule where wsid = ?';
    $statement = $conn->prepare($sql);
    $statement->bind_param('s', $wsid);
...
<body class="container">
    <h1>ระบบแจ้งซ่อมคอมพิวเตอร์:ลบตารางงานซ่อมคอมพิวเตอร์</h1>
    ...
    ?>
    <p>คุณต้องการลบหรือไม่ ? <b><?php echo $row["wsid"];?></b></p>
    <form method="post">
